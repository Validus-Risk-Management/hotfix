...
## [0.4.0](https://github.com/Validus-Risk-Management/hotfix/compare/hotfix-message-v0.3.2...hotfix-message-v0.4.0) - 2026-09-11

### Added

- introduce flag validate_user_defined_fields ([#352](https://github.com/Validus-Risk-Management/hotfix/pull/352))

## [0.3.2](https://github.com/Validus-Risk-Management/hotfix/compare/hotfix-message-v0.3.1...hotfix-message-v0.3.2) - 2026-02-09
